...
**Performance Validation**: `/status/summary` and `/lineage` latency targets are enforced by perf tests T016/T016a, and telemetry/retention targets are asserted in T055 to keep the p95 ≤200ms goal observable over time.
