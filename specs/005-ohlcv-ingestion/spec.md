...
- **FR-004 (experience, performance)**: Status page MUST refresh or be refreshable on demand and load summarized coverage/freshness data with ≤2s Time-to-Interactive and ≤2.5s Largest Contentful Paint for the 10 assets, while status/lineage APIs sustain p95 latency ≤200ms; backend implementation details remain hidden.
