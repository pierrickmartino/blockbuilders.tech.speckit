...
const colorTokens: DesignToken[] = [
  ...
  },
  {
    ...
    value: '#D1E3FF',
    darkValue: '#1F2A37',
    description: 'Soft background for light brand accents.',
    aliases: ['brand.light'],
    status: 'approved',
    version: '1.0.0',
  },
  {
    ...
    value: '#1A56DB',
    darkValue: '#7AA5FF',
    description: 'Core brand action and emphasis color.',
    wcagRatio: 4.9,
  ...
  },
  {
    ...
    value: '#0F3F96',
    darkValue: '#A3B9FF',
    description: 'High-emphasis brand color for hover and focus states.',
    wcagRatio: 5.0,
    aliases: ['brand.primary-emphasis'],
    status: 'approved',
    version: '1.0.0',
  },
];
