"""Seed OHLCV dataset for US2 checksum/backfill tests.

The dataset uses deterministic timestamps and prices so checksum expectations
stay stable across runs. Two buckets per asset per interval keep payloads
small while exercising multi-asset aggregation.
"""
