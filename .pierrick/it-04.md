...
The application must use the same technology stack as the current project (Next.js 15, React 19, Tailwind CSS, shadcn/ui). It must also use React Flow for its canvas design. 
