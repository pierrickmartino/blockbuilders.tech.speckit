...
- Node.js 20 (Next.js 15, React 19) for status page; Python 3.12 (FastAPI workers) for ingestion/ETL + Next.js 15 App Router, Tailwind 3.4 + shadcn/ui, Supabase JS client; FastAPI + Pydantic v2; Supabase.com hosted Postgres partitioned tables for OHLCV (005-ohlcv-ingestion)
- Supabase.com hosted Postgres native partitions (minute/day) plus ingestion_runs, lineage, remediation logs (005-ohlcv-ingestion)
...
## Recent Changes
- 005-ohlcv-ingestion: Added Node.js 20 (Next.js 15, React 19) for status page; Python 3.12 (FastAPI workers) for ingestion/ETL + Next.js 15 App Router, Tailwind 3.4 + shadcn/ui, Supabase JS client; FastAPI + Pydantic v2; Supabase.com hosted Postgres with native partitioning (no Timescale extension)
